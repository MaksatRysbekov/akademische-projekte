...
/**
 * The class is needed to draw a GanttChart.
 *
 * @param <X> X-Axis
 * @param <Y> Y-Axis
 */
public class GanttChart<X, Y> extends XYChart<X, Y> {
	...
	/**
	 * The static class ExtraData to specifying the GanttChart.
	 *
	 */
	...
	/**
	 * A second conctructor of the GanttChart including data.
	 * @param xAxis
	 * @param yAxis
	 * @param data
	 */
	...
	/**
	 * This method define the layout of the GanttChart.
	 */
	@Override
	...
	/**
	 * This method add a block to the plot children.
	 */
	@Override
	...
	/**
	 * This metod remove a block of the plot children with the series and item of them.
	 */
	@Override
	...
	/**
	 * This method will remove a series.
	 */
	@Override
	...
	/**
	 * This method creates a container for a series specified with a seriesIndex including a item with a index.
	 * @param series
	 * @param seriesIndex
	 * @param item
	 * @param itemIndex
	...
	/**
	 * This method update the axis range of the GanttChart.
	 */
	@Override
