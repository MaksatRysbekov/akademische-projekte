...
public abstract class Command
{
    ...
    /**
     * @return secondWord if it isn't null; null otherwise.
     */
     ...
     */
    /**
     * @param secondWord - the word entered after the command word
     */
     ...
     */
    public abstract boolean execute(Player player, JTextArea textArea);
    /**
     * help gor different commands
     * @return advice on command
     * */
